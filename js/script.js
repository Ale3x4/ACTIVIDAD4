...
document.addEventListener("DOMContentLoaded", function () {
    ...
    popupLink.addEventListener("click", function (event) {
        event.preventDefault(); // Evitar que el enlace siga su URL original
        var popupURL = popupLink.getAttribute("href");
        var popupWindow = window.open(popupURL, "PopupWindow", "width=800,height=600");
        // Puedes ajustar el ancho y la altura según tus necesidades
    });
});
